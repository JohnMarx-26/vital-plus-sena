  ...
  if (isEditing) {
    ...
    detailProductInfo(id).then((data) => {
      ...
      setFormData((prev) => ({
        ...
        pharmaceuticalForm: String(data.pharmaceuticalFormId ?? ""),
        presentation: String(data.presentationId ?? ""),
        administrationRoute: String(data.administrationRouteId ?? ""),
        lab: String(data.labId ?? ""),
        ...
        salePrice: String(data.price ?? ""),
        salePriceDiscount: String(data.discount ?? ""),
        description: data.description ?? "",
        category: String(data.categoryId ?? ""),
        avatarUrl: data.image ?? null,
        requiresPrescription: data.requiresPrescription ?? "No",
      }));
    });
  }
}, [id]);
