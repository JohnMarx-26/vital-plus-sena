...
export default function UserConfigModal({ isOpen, onClose }) {
  ...
  const handleGenerateReport = async () => {
    try {
      ...
      if (scope === "documentNumber" && !documentNumber.trim()) {
        alert("Debes ingresar un número de documento para filtrar.");
        return;
      }
